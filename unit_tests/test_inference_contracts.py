#!/usr/bin/env python3
"""Unit tests for physical-space inference contracts."""
...
def _build_wrapper() -> PhysicalSpaceStandaloneModel:
    """Build a minimal physical-space wrapper for inference contract tests."""
...
class InferenceContractTests(unittest.TestCase):
    ...
    def test_wrapper_rejects_nonpositive_time_conditioning(self) -> None:
        wrapper = _build_wrapper()

        with self.assertRaisesRegex(ValueError, "time_s must be strictly positive"):
            wrapper(
